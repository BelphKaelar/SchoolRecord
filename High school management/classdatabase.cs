...
namespace High_school_management
{
    internal class classdatabase
    {
        protected SqlConnection getconnection()
        {
            ...
            //return con;
            SqlConnection con = new SqlConnection("@Data Source=Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\admin\\Documents\\Dulieuhs.mdf;Integrated Security=True;Connect Timeout=30");
            return con;
        }
